package com.ruby.apps.studio.rubyvpn.db;

import android.provider.BaseColumns;

/**
 * ServerEntry определяет схему таблицы для базы данных SQLite,
 * используемой для хранения информации о серверах. Таблица имеет столбцы для хранения информации о хост-имени,
 * IP-адресе, показателях скорости, страны, количестве сессий VPN, времени работы, пользователей,
 * трафике, типе логирования и других параметрах сервера.
 */
