package com.ruby.apps.studio.rubyvpn.view.activites;
...
import com.ruby.apps.studio.rubyvpn.BuildConfig;
import com.ruby.apps.studio.rubyvpn.R;
import com.ruby.apps.studio.rubyvpn.SharedPreference;
import com.ruby.apps.studio.rubyvpn.adapter.ServerAdapter;
import com.ruby.apps.studio.rubyvpn.databinding.ActivityChangeServerBinding;
import com.ruby.apps.studio.rubyvpn.db.DbHelper;
import com.ruby.apps.studio.rubyvpn.model.Server;
import com.ruby.apps.studio.rubyvpn.utils.CsvParser;
...
/**
 * Этот класс представляет активность ChangeServerActivity, которая отображает список доступных VPN-серверов.
 * Она также позволяет выбрать один из серверов и сохранить его для использования в других частях приложения.
 * Класс содержит методы для инициализации списка серверов, настройки RecyclerView и SwipeRefreshLayout,
 * загрузки рекламы и интерститиальной рекламы, а также для отображения диалога с информацией о приложении.
 * Он также использует классы SharedPreference и DbHelper для сохранения и получения данных о серверах.
 * В целом, класс ChangeServerActivity помогает пользователю выбрать и
 * сохранить нужный VPN-сервер для использования в приложении.
 */
