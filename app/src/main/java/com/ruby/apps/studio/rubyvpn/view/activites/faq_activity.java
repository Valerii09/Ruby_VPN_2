...
/**
 * Этот класс отображает списком часто задаваемые вопросы (FAQ) и ответы на них в приложении на Android.
 * Он использует RecyclerView для отображения списка, а также ExpansionLayout для расширения блока ответа на вопрос
 * при нажатии на соответствующий вопрос. Класс содержит адаптер RecyclerView (RecyclerAdapter),
 * который загружает вопросы и ответы на вопросы из ресурсов приложения и заполняет ими список.
 * Класс также содержит методы, которые связывают данные с представлением, определяют HTML-содержимое
 * и настраивают расширение / сворачивание в зависимости от состояния.
 */
